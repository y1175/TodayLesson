...
<h3 style="margin: 10px auto;" >계좌정보</h3>
...
<li>
<label>계좌번호</label>
<input type="text" id="senior_account_num" name="senior_account_num" required="required" value="${dto.senior_account_num }" class="form-control" style="width:20%;display:inline-block;">
...
<tr><td><b>예금주</b></td><td><input type="text" id="senior_account_name" name="senior_account_name" required="required" value="${dto.senior_account_name }" class="form-control" style="width:70%; margin:5px;""></td></tr>
<tr><td><b>계좌번호</b></td><td><input type="text" id="senior_account_num" name="senior_account_num" required="required" value="${dto.senior_account_num }" class="form-control" style="width:70%;display:inline-block;float:left; margin:5px;"">
