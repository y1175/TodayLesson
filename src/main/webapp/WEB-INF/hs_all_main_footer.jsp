...
<!-- CSSstyle -->
   <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/CSS/hs_all_main_footer.css?ver=4">
<!-- CSSstyle -->
</head>
<body>
   <div class="hs_footer" style="position: relative; top: 100px;">
      <div class="row" style="width: 80%; margin: auto; ">
         <div class="col-md-12" style="margin-top: 20px;">
            <div class="col-sm-8"style="padding: 10px 0px; font-size: 15px;">
               <b> 회사소개 </b>
               <b> 서비스이용약관 </b>
               <b> 개인정보취급방침 </b>
               <b> 고객센터 </b>
         ...
         <div class="hs_foot_line"></div>
         
         <div class="col-md-12" id="hs_foot_content">
            <b style="font-size: 37px; margin-left: 5px; color: rgb(224, 62, 82);">오늘의 레슨</b>
            <p>(주)TodayLesson</p>
