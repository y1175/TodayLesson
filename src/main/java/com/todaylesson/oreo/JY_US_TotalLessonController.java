...
public class JY_US_TotalLessonController {
	...
	public String ttlesson_list(Model model, @RequestParam(required = false, defaultValue = "") String search,
		...
		List<LessonDTO> list = ttlesson_service.ttlesson_list(search, searchtxt, order, page.getStartRow(),
				page.getEndRow(), cate);
	...
	public String lesson_cart(@RequestParam(value = "lesson_no") int lesson_no,
		...
		AllLessonDTO ldto = ttlesson_service.ttlesson_select(lesson_no);
		int junior = ldto.getLesson_member_max() - ldto.getLesson_junior_count();
	...
	public String orderlist_detail(OrderDetailDTO oddto, OrderListDTO oldto,
			...
			@RequestParam(value = "member_id") String member_id, Model model) {
