...
// 쿼리문은 mapper.xml에서 확인 가능
		  ...
		  public void t1()
		  {
			  ...
			  dto.setMember_no(20);
			  dto.setMember_id("us2");
			  dto.setMember_pwd("us2");
			  dto.setMember_name("us2");
			  ...
			  dto.setMember_nick("US2_왕밤빵");
			  dto.setMember_img("US2_왕밤빵");
			  dto.setEnabled(true);
			  ArrayList<Member_AuthDTO> arr=new ArrayList<>();
			  arr.add(new Member_AuthDTO("ROLE_USER","us2"));
			  dto.setAuthList(arr);
